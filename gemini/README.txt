...
QUY TẮC SỬ DỤNG
---------------
1. Dùng gemini/instructions/### MASTER_CORE v2.7.txt làm canonical instruction.
2. Các PDF trong gemini/knowledge-base/ là Knowledge Base theo routing function.
...
6. Các prompt cũ trong archive/versions/ là lịch sử/phục vụ regression, không override canonical v2.7.
